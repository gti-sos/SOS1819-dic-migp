        ...
        $http.get(API).then(function(response) {
            ...
            paises.filter((c) => {
                if(rates.filter(x => x.country == c && x.year==2016)[0] == undefined){
                    ...
                    year2016.push(rates.filter(y => y.country == c && y.year==2016)[0].mortality);
                }
                if(rates.filter(x => x.country == c && x.year==2017)[0] == undefined){
                    year2017.push("");
                } else {
                    year2017.push(rates.filter(y => y.country == c && y.year==2017)[0].mortality);
                }
                if(rates.filter(x => x.country == c && x.year==2018)[0] == undefined){
                    year2018.push();
                } else {
                    year2018.push(rates.filter(y => y.country == c && y.year==2018)[0].mortality);
                }
              ...
              paises.filter((c) => {
                  ...
                  if(rates.filter(x => x.country == c && x.year==2016)[0] == undefined){
                      ar.push("");
                        ...
                        ar.push(rates.filter(y => y.country == c && y.year==2016)[0].natality);
                    }
                    if(rates.filter(x => x.country == c && x.year==2017)[0] == undefined){
                        ar.push("");
                    } else {
                        ar.push(rates.filter(y => y.country == c && y.year==2017)[0].natality);
                    }
                    if(rates.filter(x => x.country == c && x.year==2018)[0] == undefined){
                        ar.push();
                    } else {
                        ar.push(rates.filter(y => y.country == c && y.year==2018)[0].natality);
                    }
                    c3datos.push(ar);
              });
